 ...
 *
 * <p>These tests intentionally do not inspect the vector's representation. A slot may move between
 * a primitive and a wide representation, but it must always expose one exact value.
 */
